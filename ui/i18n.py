TRANSLATIONS = {
    "zh": {
        ...
        "upload_config_tip": "上传配置",
        "upload_config_title": "上传配置",
        "upload_config_filter": "Alas 配置文件 (*.json)",
        "upload_config_invalid_name": "配置文件名无效。",
        "upload_config_exists": "远端已存在配置 “{config}”。是否覆盖？",
        "upload_config_overwrite": "覆盖",
        "upload_config_failed": "上传配置失败：\n{error}",
        "upload_config_success": "已上传配置 “{config}”。",
        "upload_config_invalid_alas": "不是有效的 Alas 配置：{reason}",
        "alas_config_error_root_not_object": "JSON 顶层必须是对象。",
        "alas_config_error_too_few_sections": "配置分组数量过少，当前仅 {detail} 个。",
        "alas_config_error_missing_section": "缺少必要分组：{detail}。",
        "alas_config_error_invalid_section": "分组结构无效：{detail}。",
        "alas_config_error_missing_group": "缺少必要子分组：{detail}。",
        "alas_config_error_invalid_group": "子分组结构无效：{detail}。",
        "alas_config_error_missing_emulator_key": "Alas.Emulator 缺少必要字段：{detail}。",
        "alas_config_error_invalid_storage": "Storage 结构无效：{detail}。",
        "alas_config_error_too_few_schedulers": "调度任务数量过少，当前仅 {detail} 个。",
        "alas_config_error_invalid_scheduler": "Scheduler 结构无效：{detail}。",
    ...
    "en": {
        ...
        "upload_config_tip": "Upload config",
        "upload_config_title": "Upload Config",
        "upload_config_filter": "Alas config files (*.json)",
        "upload_config_invalid_name": "Invalid config file name.",
        "upload_config_exists": "Config \"{config}\" already exists on the server. Overwrite it?",
        "upload_config_overwrite": "Overwrite",
        "upload_config_failed": "Failed to upload config:\n{error}",
        "upload_config_success": "Uploaded config \"{config}\".",
        "upload_config_invalid_alas": "Not a valid Alas config: {reason}",
        "alas_config_error_root_not_object": "JSON root must be an object.",
        "alas_config_error_too_few_sections": "Too few config sections. Found {detail}.",
        "alas_config_error_missing_section": "Missing required section: {detail}.",
        "alas_config_error_invalid_section": "Invalid section structure: {detail}.",
        "alas_config_error_missing_group": "Missing required group: {detail}.",
        "alas_config_error_invalid_group": "Invalid group structure: {detail}.",
        "alas_config_error_missing_emulator_key": "Alas.Emulator is missing required keys: {detail}.",
        "alas_config_error_invalid_storage": "Invalid Storage structure: {detail}.",
        "alas_config_error_too_few_schedulers": "Too few scheduler tasks. Found {detail}.",
        "alas_config_error_invalid_scheduler": "Invalid Scheduler structure: {detail}.",
